...
function compile(_ref) {
  ...
  Object.keys(contracts).forEach(function (contractName) {
    ...
    // Write Doxity metadata to doxity_metadata_files directory
    _fs2.default.writeFileSync(doxity_simpletonFolderPath + '/doxity_metadata_files/' + contractName + '.json', JSON.stringify(contract) + '\n');
